...
hunger_games = media.Movie("Hunger Game",
                           "Victory in the 74th Hunger Games \
...
midnight_in_paris = media.Movie("Midnight in Paris",
                                "A screenwriter finds himself going \
                                 back to the 1920s everyday at midnight",
                                "https://upload.wikimedia.org/wikipedia/en/9/9f/Midnight_in_Paris_Poster.jpg",  # noqa
                                "https://www.youtube.com/watch?v=BYRWfS2s2v4")

school_of_rock = media.Movie("School of Rock",
                             "A teacher of a elementary private school trying \
                              to turn it into a rock band.",
